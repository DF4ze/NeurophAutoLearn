...
public class DigitsRecognition {
    ...
    public static void main(String args[]) {
        ...
        FitDataSet dataSet = generateTraining();
     ...
     */
    public static void testNeuralNetwork(NeuralNetwork neuralNet, FitDataSet testSet) {
    ...
    public static FitDataSet generateTraining() {

        FitDataSet dataSet = new FitDataSet(Data.CHAR_WIDTH * Data.CHAR_HEIGHT, Data.DIGITS.length);
        ...
        for (int i = 0; i < Data.DIGITS.length; i++) {
            ...
            FitDataSetRow row = new FitDataSetRow(input, output);
